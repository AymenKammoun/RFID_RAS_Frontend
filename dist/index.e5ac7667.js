...
const members = (0, _jqueryDefault.default)("#members");
(0, _jqueryDefault.default)(document).ready(async ()=>{
    getPresentMembers();
});
async function getPresentMembers() {
    let response = await (0, _jqueryDefault.default).get(route + "get_presence_list");
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4PWRH","aitAD"], "aitAD", "parcelRequirefc40")
